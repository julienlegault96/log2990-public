...
import { ImgDiffRoute } from "./imgdiff";
...
describe("Imgdiff service", () => {
    const imgDiffRoute: ImgDiffRoute = new ImgDiffRoute();
    ...
    it("should return image data", async () => {
        imgDiffRoute["getById"] = async () => GAMES[0];

        // ce test retourne toujours un string
        const imgDiffData: string = await imgDiffRoute["getDiffImgData"]("gameId", ImageView.FirstView) as string;
