...
private:
    ...
    double theta_;         // angle de rotation de la caméra (coord. sphériques)
    double phi_;           // angle de rotation de la caméra (coord. sphériques)
    double previousTheta_;
    double previousPhi_;
    double dist_;          // distance (coord. sphériques)
};
